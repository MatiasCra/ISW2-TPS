...
/**
 * FalseConditionalsMutator: Se reemplazó !java.util.Arrays.equals(elems, other.elems) por false en la línea 123.
 */
public class StackArMutated5150 extends org.autotest.Stack {
    ...
    public StackArMutated5150() {
        this(org.autotest.mutants.StackArMutated5150.DEFAULT_CAPACITY);
    }

    public StackArMutated5150(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated5150 other = ((org.autotest.mutants.StackArMutated5150) (obj));
        if (false) {
            return false;
        }
