...
/**
 * TrueConditionalsMutator: Se reemplazó !java.util.Arrays.equals(elems, other.elems) por true en la línea 123.
 */
public class StackArMutated3699 extends org.autotest.Stack {
    ...
    public StackArMutated3699() {
        this(org.autotest.mutants.StackArMutated3699.DEFAULT_CAPACITY);
    }

    public StackArMutated3699(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated3699 other = ((org.autotest.mutants.StackArMutated3699) (obj));
        if (true) {
            return false;
        }
