 ...
 */
public class StackArMutated3868 extends org.autotest.Stack {
    ...
    public StackArMutated3868() {
        this(org.autotest.mutants.StackArMutated3868.DEFAULT_CAPACITY);
    }

    public StackArMutated3868(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated3868 other = ((org.autotest.mutants.StackArMutated3868) (obj));
        if (true) {
            return false;
        }
