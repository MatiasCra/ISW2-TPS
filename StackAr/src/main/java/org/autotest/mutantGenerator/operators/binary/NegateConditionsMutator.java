...
public class NegateConditionsMutator extends MutationOperator {
    ...
    public boolean isToBeProcessed(CtElement candidate) {
        ...
        List<BinaryOperatorKind> targetOperations = Arrays.asList(BinaryOperatorKind.EQ, BinaryOperatorKind.NE,
                BinaryOperatorKind.LE, BinaryOperatorKind.GE, BinaryOperatorKind.LT, BinaryOperatorKind.GT);
    ...
    public String describeMutation(CtElement candidate) {
        CtBinaryOperator op = (CtBinaryOperator) candidate;
        return this.getClass().getSimpleName() + ": Se reemplazó " + BinaryOperatorKindToString.get(op.getKind()) +
                " por " + BinaryOperatorKindToString.get(getReplacement(op.getKind())) + " en la línea " + op.getPosition().getLine() + ".";
    }
}
